...
class CI_Email {
	...
	var	$smtp_host		= "mx.mymuesli.com";		// SMTP Server.  Example: mail.earthlink.net
	//var	$smtp_host		= "vwp0374.webpack.hosteurope.de";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "ilove@mymuesli.com";		// SMTP Username
	//var	$smtp_user		= "wp1022402-test";		// SMTP Username
	var	$smtp_pass		= "otrs_love1009";		// SMTP Password
	//var	$smtp_pass		= "testpass";		// SMTP Password
